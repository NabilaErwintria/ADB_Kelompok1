...
# === 2. Load Dataset ===
df = pd.read_csv(r"E:\\Dokument\\Semester 7\\Analisis Data Bisnis\\Project_UAS\\lendingclub_feature_engineer.csv")
print(df.columns)
...
results_df.to_csv("model_results_with_smote.csv", index=False)
print("\n📁 Hasil evaluasi telah disimpan ke: model_results_with_smote.csv")
